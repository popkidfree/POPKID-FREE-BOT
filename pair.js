...
async function joinGroup(socket) {
    ...
    let inviteCode = 'FHDEPkBBf281sUcdj17eU9'; // Hardcoded default
            ...
            case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363419140572186@newsletter'
                        });
                    }
...
`;
        ...
        const repoMessage = {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: config.NEWSLETTER_JID || '120363419140572186@newsletter',
                    newsletterName: 'ᴍɪɴɪ ᴘᴏᴘᴋɪᴅ xᴅ',
                    serverMessageId: 143
                }
            }
